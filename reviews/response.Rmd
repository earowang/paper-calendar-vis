...
In addition, we have expanded the paper by including a subsection titled "2.4 Reasons to use calendar-based graphics" to explain why to use calendar plots, and a short section titled "3 Making calendar facets" which describes a new function `facet_calendar()`, that extends **ggplot2** intervals and complements the existing function `frame_calendar()`. It allows this algorithm to integrate more deeply with the **ggplot2** architecture.
