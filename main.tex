...
routine starts after 6pm on week days. Figures \ref{fig:dow} and
...
Figure \ref{fig:h12} and \ref{fig:h34} display the data in calendar
layout individually for each household, unfolding their day-to-day life.
...
stripes and clusters in Figure \ref{fig:hod}. The calendar plots speak
