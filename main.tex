...
a month. \(k\) is day of the week, \(g\) is day of the month, \(i,j\)
indicates grid position.]{Illustration of the indexing layout for cells in
a month. \(k\) is day of the week, \(g\) is day of the month, \(i,j\)
indicates grid position.}\label{fig:month-diagram}
\end{figure}
\end{CodeChunk}
