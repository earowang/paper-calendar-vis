...
better glimpse of the daily and sub-daily pedestrian patterns.
...
\ref{fig:fs-2016} placed in polar coordinates.
...
Figure \ref{fig:overlay} it can be seen that the State Library has a
similar temporal trend to Flagstaff Station on non-work days. The
...
incoming and outgoing traffic to Flagstaff Station and the State
Library.
