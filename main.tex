...
behavior, such as pedestrian patterns. It may not work so well for
physical patterns like temperature, which are not typically affected by
human activity. Additionally, it is perceptually difficult to discover
an overall trend, since there is no common baseline due to the rows and
columns of a display matrix.
