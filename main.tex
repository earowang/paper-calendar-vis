...
\caption[Time series plot]{Time series plot}\label{fig:time-series-plot}
\end{figure}
\end{CodeChunk}
...
\caption[Time facet]{Time facet}\label{fig:facet-time}
\end{figure}
\end{CodeChunk}
...
\begin{center}\includegraphics[width=\textwidth]{figure/flinders-2016-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{figure/flinders-free-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{figure/scatterplot-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{figure/overlay-1} \end{center}
...
\begin{center}\includegraphics[width=\textwidth]{figure/boxplot-1} \end{center}
