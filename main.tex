...
missing piece of the picture. Also weekday and weekend
...
\caption{Arranging sub-daily energy usage into monthly grids reveals the vacation time periods for households 1 and 3, which are hidden in Figure \ref{fig:dow} and \ref{fig:hod}.}\label{fig:h12}
\end{figure}
...
\caption{Arranging sub-daily energy usage into monthly grids reveals the vacation time periods for households 1 and 3, which are hidden in Figure \ref{fig:dow} and \ref{fig:hod}.}\label{fig:h34}
\end{figure}
