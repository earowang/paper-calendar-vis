...
features multiple temporal scales such as time of day, day of week, day
...
accomplishing visualisation with the grammar of graphics. We describe
its construction along with a few options. We provide some variations to
demonstrate its usage by applying to the pedetrian data over one-year
period of 2016.
}
...
if simply using coloured blocks rather than curves, it may become
perceptually difficult to accurately judge the shape positions and
changes, although the glyphs come with the cost of more display capacity
...
implemented as the \code{frame_calendar} function in the \pkg{sugrrants}
...
\caption[Line glyphs on polar coordinates]{Line glyphs on polar coordinates.}\label{fig:flinders-polar}
\end{figure}
\end{CodeChunk}
...
similar temporal trend as Flinders Street Station on non-work days. The
nighttime events, such as White Night and New Year Evening Firework, has
...
\caption[Line graphs faceted by the 3 sensors in the 6 by 2 monthly calendar]{Line graphs faceted by the 3 sensors in the 6 by 2 monthly calendar.}\label{fig:facet}
\end{figure}
\end{CodeChunk}
