...
its construction along with a few options. We provide some examples to
demonstrate its usage by applying to the pedetrian data.
}
...
\caption[Line graphs faceted by the 3 sensors in the monthly calendar]{Line graphs faceted by the 3 sensors in the monthly calendar.}\label{fig:facet}
\end{figure}
\end{CodeChunk}
...
\code{x} and lagged themselves to the \code{y}. It provides a visual
