...
\caption{Letter value plot of daily energy usage against day of week by households. The enery consumed by household 2 exhibits much larger variability, cotrast to the rest households. Households 1, 2, and 4 use mose energy over the weekends.}\label{fig:dow}
\end{figure}
...
{\centering \includegraphics[width=\textwidth]{figure/household23-1} 
