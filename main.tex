...
The \code{frame_calendar} function assumes that the underlying data
...
The \code{frame_calendar} does not constrain itself to mapping only
temporal variable to the \code{x}. Figure \ref{fig:scatterplot} shows
the lag scatterplot where hourly counts are assigned to the \code{x} and
lagged themselves to the \code{y}. It provides a visual tool for
