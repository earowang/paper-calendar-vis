...
routine starts after 6pm on week days.
...
Figures \ref{fig:dow} and \ref{fig:hod}, part of a traditional graphical
toolkit, are useful for summarizing overall deviations across days and
households. Figure \ref{fig:h12} and \ref{fig:h34} display the data in
calendar layout individually for each household, unfolding their
day-to-day life. Glancing through Figure \ref{fig:h12}, their week day
