...
A snapshot is taken at a different time resolution to picture
...
\caption{Scatterplot between time of day and half-hourly energy usage, constrasting workdays and non-work days for each household. A distinctive pattern exclusive to household 2 is popped out: a fair amount of points are clustered above 1 kWh over all time of day. (too generic, when they get up and different between work day and non-work days)}\label{fig:hod}
\end{figure}
