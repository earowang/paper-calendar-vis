...
and it is particularly useful to visualise people's daily schedules. One
example is Melbourne pedestrian counts which are captured at hourly
interval by a number of sensors. Owing to human activities, the data
feature multiple temporal scales such as time of day, day of week, day
of year. We describe its construction along with a few options. We
provide some variations to demonstrate its usage by applying to the
pedetrian data over one-year period of 2016.
}
