...
the week days given the medians, compared to the others consisting of
one or two people. Whereas, household 2 displays a great deal of
...
households (1 and 4) tend to consume more energy on average with
increased variations during the weekends relative to the week days, as a
reflection of work and leisure patterns.
...
day between week days and weekends. Household 1 is an early bird,
...
share a consistent energy pattern between week days and weekends. As for
household 4, their home routine starts after 6pm on week days. Figure
...
Glancing through Figure \ref{fig:h12}, their week day energy use
...
\caption{Calendar displays for household 1. They tend to use air conditioning in the late afternoon untill the mid-night in summer. It seems that they are on vacation in June.}\label{fig:h1}
\end{figure}
...
\caption{Calendar displays for household 2. It reveals their regular tendency of using air conditioning and heating, and vacation periods. They leaves heating on consecutively in the mid July, is on holiday for Christmas and the second week of June.}\label{fig:h2}
\end{figure}
...
\caption{Calendar displays for household 3. Their energy use reveals different behaviors between summer and winter: only one peak in most summer days, while two peaks in winter. They are on long trips twice in the past year.}\label{fig:h3}
\end{figure}
...
\caption{Calendar displays for household 4. Energy are heavily used in the evening for household 4. They also take three short trips in October, December, and June.}\label{fig:h4}
\end{figure}
