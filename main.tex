...
business planning. To take a glimpse at such temporal-context data, we
start with the conventional time series plot (Figure
\ref{fig:time-series-plot}). Figure \ref{fig:facet-time} lends itself to
a number of issues that make exploratory data visualisation challenging
in many temporal-context applications involving human behaviours:
...
\caption[Time series plot about the number of pedestrians over the year of 2016 at a selection of 7 sensors in the city of Melbourne]{Time series plot about the number of pedestrians over the year of 2016 at a selection of 7 sensors in the city of Melbourne. Coloured by the sensors, small multiples of lines show the foot traffic varies from one sensor to another in terms of both time and number. The traffic, specifically at two train stations (Flagstaff Station and Flinders Street Station), is primarily driven by the commuters, as depicted in the graph.}\label{fig:time-series-plot}
\end{figure}
\end{CodeChunk}
