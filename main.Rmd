...
(ref:month-diagram-cap) Illustration of the indexing layout for cells in a month. $k$ is day of the week, $g$ is day of the month, $i,j$ indicates grid position.
...
(ref:year-diagram-cap) Illustration of the indexing layout for months of one year. $M,N$ indicate number of rows and columns, $b$ is a space parameter separating cells.
