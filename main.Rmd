...
```{r flinders-polar, fig.height = 6.5, fig.cap = "Star plots of hourly pedestrian counts at Flinders Street Station, which are line charts placed in polar coordinates. The periodic behaviors on workdays are clearly visible."}
```
