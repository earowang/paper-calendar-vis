...
```{r flinders-polar, fig.height = 6.5, fig.cap = "Line glyphs on polar coordinates."}
```
...
```{r facet, fig.height = 11, fig.cap = "Line graphs faceted by the 3 sensors in the 6 by 2 monthly calendar."}
```
