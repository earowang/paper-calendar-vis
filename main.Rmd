...
The \code{free_wday} scales each week day together. It can be useful to comparing trends across week days, allowing relative patterns for weekends vs week days to be examined. Similarly, the \code{free_mday} uses free scaling for any day within a given month. 
