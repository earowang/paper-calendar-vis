...
```{r calendar-elec, fig.height = 10.5, fig.cap = "Calendar displays for each household using common scales. We can precisely tell each indidual's vacation days to take off and the overnight use for household 2."}
```
