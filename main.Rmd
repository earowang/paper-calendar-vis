...
```{r time-series-plot, fig.height = 6, fig.cap = "Time series plots showing the number of pedestrians in 2016 measured at three different sensors in the city of Melbourne. Colored by the sensors, small multiples of lines show that the foot traffic varies from one sensor to another in terms of both time and number. The weekly patterns look distinctive across these three sensors. There are eye-catching spikes which occurred at the State Library and Birrarung Marr, caused by the annual White Night event on 20th of February."}
```
