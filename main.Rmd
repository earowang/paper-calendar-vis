...
2. Since the data are often collected at daily frequency or a time scale more frequent than daily, they typically involve large number of observations spanning over a long time period.
...
The remainder of the paper is organised as follows. Section \ref{sec:algorithm} describes the \code{frame_calendar} function and its construction in detail. Section \ref{sec:examples} presents examples using a range of geometric objects. Section \ref{sec:discussion} discusses the advantages and disadvantages of the method.
