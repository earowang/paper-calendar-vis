...
```{r fs-polar, fig.height = 7, fig.cap = "Figure \\ref{fig:fs-2016} in circular layout, which is referred to as star plots. The daily periodicity on work days are clearly visible.", eval = FALSE}
```
