...
Figure \ref{fig:dow} and \ref{fig:hod}, part of traditional graphical toolkits, are useful for summarizing overall deviations across days and households. Is there any untold story from these plots? Figure \ref{fig:household13} lays out the data points at the finest time resolution in a $3 \times 4$ monthly grid, for household 1 and 3. Household 1 was on vacation over three weeks of June, and household 2 was also away for holidays from September to early October and late June to mid July in the past year. This calendar plot evidently fills the missing piece of the picture. Also weekday and weekend

```{r h12, fig.height = 10, fig.cap = "Arranging sub-daily energy usage into monthly grids reveals the vacation time periods for households 1 and 3, which are hidden in Figure \\ref{fig:dow} and \\ref{fig:hod}."}
```

```{r h34, fig.height = 10, fig.cap = "Arranging sub-daily energy usage into monthly grids reveals the vacation time periods for households 1 and 3, which are hidden in Figure \\ref{fig:dow} and \\ref{fig:hod}."}
```
