...
The algorithm can be extended relatively easily to layout multiple years, or to lay out different calendar formats like weeks of a year.
...
(INTERACTIVITY COULD BE DISCUSSED HERE) We shall enable interactivity in the calendar-based graphics for time series data. It will allow users to transform different temporal components and switch displays between overlaying and faceting through key strokes or mouse clicks.
