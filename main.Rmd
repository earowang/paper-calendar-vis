...
<!-- 2. Temporal data plots should be arranged in a way that serves a familiar format to viewers. -->
...
```{r write-bib}
write_bib(c(.packages(), "geofacet"), 'packages.bib')
```
