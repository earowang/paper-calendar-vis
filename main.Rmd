...
```{r time-series-plot, fig.cap = "Time series plot"}
```

```{r facet-time, fig.cap = "Time facet"}
```
...
```{r flinders-2016, fig.height = 6.5}
```
...
```{r flinders-free, fig.height = 6.5}
```
...
```{r overlay, fig.height = 6.5}
```

```{r boxplot, fig.height = 6.5}
```
